...
$SSASServerName = "chdc\DataMartTest"
...
$Result | Select DatabaseName, RoleName, UserName | sort-object -property DatabaseName | Export-Csv u:\target\DataMartTestMultiDimensional.csv -NoTypeInformation
